...
###This will generate data.csv in the dataset folder

###NOTE: set the fault directory to where the codes folder is located by using setwd("path").
DIREC="codes/Application/dataset/rawDatasets/rawDatasets/" ### location of all the raw data files after unzipping rawDatasets.zip
